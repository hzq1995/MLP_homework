...
class MlpNn:
    ...
    def fit(self, train_x, train_y, epoch,
            optimizer='momentum', loss_type='square_loss', learn_rate=0.001, learn_decay=0.0002, verbose=None):
        cost_record = []
        div = epoch / 10
        ...
        for eps in range(epoch):
            ...
            for i in range(self.m):
                ...
                self.cost += loss
                # back_propagation
                self.back_propagation(p, y, optimizer, learn_rate, learn_decay, loss_type)
